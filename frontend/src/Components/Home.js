    ...
    <>
      ...
      <div className="footer">
        <div className="social-icon">
          <a
            href="https://github.com/manishmandal55"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/manish-mandal-04-05peace/"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="mailto:manishmandal23232@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
          >
